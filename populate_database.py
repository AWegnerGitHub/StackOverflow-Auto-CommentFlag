...
s.add(models.secomments.Setting(name="flagging_max_comments_length", value="100", user_manage=1))
s.add(models.secomments.Setting(name='flag_exclusion_window', value='48', user_manage=1))
